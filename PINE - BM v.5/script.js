...
const peerClaims = [
    [
        '<h2>Naše Plzeňačka <br>jde do další úrovně.</h2>',
    ...
    [
        '<h2>Náš Plzeňák <br>jde do další úrovně.</h2>',
...
const allText = [
    ...
    [
        "Rozvoj talentů",
        "Radovánek",
        `<p>Středisko volného času Radovánek rozvíjí děti, rozšiřuje okruh jejich zájmů a motivuje k aktivnímu trávení společného času. Radovánek je školským zařízením pro zájmové vzdělávání, jehož  zřizovatelem je Plzeňský kraj. Je tu pro děti, žáky, studenty a dospělé z celého kraje. Celoročně zajišťuje pravidelnou, příležitostnou a prázdninovou činnost.</p>`,
        '#fcc200',
        '66%',
        '3%',
        '3%',
    ...
    [
        "preinkubace",
        "SIT Port Garage",
        `<p>SIT Port Garage je skvělé místo pro každého, kdo chce tvořit. Garáž znamená zázemí a moderní technologie v jednom – poskytuje vybavení pro kutily, hardware i data, 3D tiskárny nebo CNC stroje. Navíc dokáže zafinancovat specifické hardwarové vybavení i testování prototypů. SIT Port Garage navíc pořádá zajímavé workshopy, které šije na míru členům SIT Port komunity a věnuje se i mentoringu zakládání a řízení firmy. Umí poradit v oblasti práva, financí nebo třeba marketingu. Vyrazit odpoledne do garáže dostává úplně nový rozměr!</p>`,
        '#7b6ce6',
        '100%',
        '100%',
        '3%',
    ...
    [
        "inkubace",
        "BIC Port",
        `<p>BIC Port organizuje inkubační programy pro začínající firmy z Plzeňského kraje, posktyuje individuální konzultace a profesionální mentoring. Nabízí možnosti technologické inkubace pro ambiciózní startupy a poskytuje možnost využití sdílených kanceláří v centru města.</p>`,
        '#00a8f0',
        '100%',
        '100%',
        '25%',
    ...
    [
        "inkubace",
        "Polygon pro autonomní mobilitu",
        `<p>V Plzni se rozvíjí unikátní polygon pro autonomní mobilitu. Je usazen do reálného provozu města, napojen na jeho digitální dvojče, dopravní infrastrukturu a systémy, 5G síť, další potřebnou senzoriku. Polygon navazuje na aktivity města v oblastech PINE, Mobility Innovation HUB, projekt autonomní tramvaje Škody Transportation a také na aktivity v oblasti dronů.</p>`,
        '#00a8f0',
        '100%',
        '100%',
        '100%',
